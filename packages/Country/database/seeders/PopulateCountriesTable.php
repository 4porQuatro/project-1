...
class PopulateCountriesTable extends Seeder {
    ...
    public function run()
    {
        $data_path = base_path().'/vendor/stefangabos/world_countries/data';
        ...
        File::copyDirectory(base_path('vendor/stefangabos/world_countries/flags'), public_path('img/cms/flags'));
    }
