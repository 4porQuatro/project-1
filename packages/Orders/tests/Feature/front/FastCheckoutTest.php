...
class FastCheckoutTest extends TestCase {
    ...
    public function setUp(): void
    {
        ...
        ShippingPrice::factory()->create(['shipping_method_id'=>$shipping_method->id, 'priceable_type'=>Zone::class, 'priceable_id'=>$zone->id, 'min_volume'=>0, 'max_volume'=>1000000, 'min_weight'=>0, 'max_weight'=>100000, 'price'=>10000]);
    }
    ...
    public function the_data_for_the_shipping_its_correctle_seeted()
    {
        ...
        $shipping_method->setShippingPriceByAttributesAndCountry($data['shipping_country'], $cart->getShippmentWeight(), $cart->getShippmentVolume());
